 ...
 */
func songLyric(problemCount:Int){
 ...
 */
func favoriteBand(rank:Int, name:String){
    print("My #\(rank) favorite band is \(name).")
}
favoriteBand(4, name:"Erika")
...
madLib("Bill", noun:"hat", preposition:"after")
 ...
 */
func statement(){
    let phrase = "Buzz Lightyear to the rescue!"
    print(phrase)
}
 ...
 */
func statement2(name:String){
    let nameUpper = name.uppercaseString
    let phrase = "To infinity and beyond, \(nameUpper)!"
    print(phrase)
}
statement2("Bill")
